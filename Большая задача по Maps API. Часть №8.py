...
"Появляется строка адреса внизу, при сбрасывании удаляется"
...
while running:
    ...
    try:  # Рисуем кнопки
        ...
        draw_buttons(address_button, 221, 221, 221, 45, 410, 450, 40, 0, address_text, 0, 0, 0)
